...
const rpslsChoices = ["rock", "paper", "scissors", "spock", "lizard"];

export function rps(playerChoice=null, oppChoice=null) {
    ...
    if (oppChoice===null) {
      ...
      compPlay = false;
      if (!rpsChoices.includes(oppChoice)){
        console.error(`${oppChoice} is out of range.`);
    ...
    if (compPlay) {
      if (playerChoice === computerChoice) {
        ...
        if (playerChoice === oppChoice) {
          const results = "tie";
          return {"player": playerChoice, "opponent": oppChoice, "result": results}
          } else if (
            (playerChoice === 'rock' && oppChoice === 'scissors') ||
...
export function rpsls(playerChoice=null, oppChoice=null) {
  ...
  if (oppChoice===null) {
    ...
    compPlay = false;
    if (!rpslsChoices.includes(oppChoice)) { 
      console.error(`${oppChoice} is out of range.`);
  ...
  if (compPlay) {
    ...
    if (playerChoice === oppChoice) {
      ...
      (playerChoice === "rock" && oppChoice === "scissors") ||
      (playerChoice === "paper" && oppChoice === "rock") ||
      (playerChoice === "rock" && oppChoice === "lizard") ||
      (playerChoice === "lizard" && oppChoice === "spock") || 
      (playerChoice === "spock" && oppChoice === "scissors") || 
      (playerChoice === "scissors" && oppChoice === "lizard") || 
      (playerChoice === "lizard" && oppChoice === "paper") ||
      (playerChoice === "paper" && oppChoice === "spock") ||
      (playerChoice === "spock" && oppChoice === "rock") ||
      (playerChoice === "scissors" && oppChoice === "paper")) {
        const results = "win";
        return {"player": playerChoice, "opponent": oppChoice, "result": results}
      } else {
